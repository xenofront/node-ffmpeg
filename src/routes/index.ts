...
route.post("/convertToMp3", (req: any, res: Response) => {
  ...
  fs.existsSync(`${global.sandboxPath}/uploads`) ||
    fs.mkdirSync(`${global.sandboxPath}/uploads`);
  fs.existsSync(`${global.sandboxPath}/converted`) ||
    fs.mkdirSync(`${global.sandboxPath}/converted`);
